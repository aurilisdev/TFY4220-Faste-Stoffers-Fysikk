...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\linewidth]{bilder/ewaldsfæren.png}
...
\begin{tcolorbox}[breakable,boxrule=0pt]
  \seksjon{Kronig-Penney modellen med Sentrallikningen}
...
\delseksjon{Direkte vs indirekte båndgap}
Måten vi kan visualisere disse to prosessene er slik:
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{bilder/indirekte_versus_direkte_båndgap.png}
...
\delkapittel{Iboende lederkonsentrasjon}
